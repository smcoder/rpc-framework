...
public class ServiceDiscovery {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Thread.sleep(2000);
        PathChildrenCache pathChildrenCache = new PathChildrenCache(serviceDiscovery.client, ServiceCommon.getServicePath(serviceRegistry.getServiceName()), true);
    ...
    public void connect() throws Exception {
        CuratorFramework client = CuratorFrameworkFactory.newClient(zkAddress, 15 * 1000, 5000, new ExponentialBackoffRetry(1000, 3));
        client.start();
    ...
    private PathChildrenCache getPathChildrenCache(String serviceName) {
        ...
        // 有多个线程执行也没关系，只不过是多加载了几个cache
        PathChildrenCache pathChildrenCache = new PathChildrenCache(this.client, ServiceCommon.getServicePath(serviceName), true);
        try {
